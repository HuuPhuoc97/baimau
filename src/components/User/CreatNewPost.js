...
class CreatNewPost extends Component {
    constructor(props) {
        super(props)
        this.state = {
            title: '',
    ...
    render() {
        ...
        if (this.props.location.pathname.indexOf('/creat-new-post') >= 0)
            return (
                                ...
                                <div className="row">
                                    ...
                                    <form className="form-text-editor">
                                        <div className="form-group editor">
                                            <ReactQuill
                                                modules={CreatNewPost.modules}
                                                formats={CreatNewPost.formats}
